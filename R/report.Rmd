---
title: "Rešerše k datům o výsledcích STK"
output:
  html_document:
    df_print: paged
---
...
Podle [poslední TÜV Report](https://www.tuv.com/de/deutschland/ueber_uns/presse/meldungen/newscontentde_411712.html) v Německu při pravidelných technických prohlídkách neprošlo 21,2 % testovaných vozidel. Jedná se o data z *pravidelných technických prohlídek* 8,8 milionů *osobních aut*, přičemž metodologie TÜV se zaměřuje na 230 nejrozšířenějších modelů na německých silnicích.
...
Ze [statistických souhrnů](https://www.mdcr.cz/Statistiky?searchtext=&searchmode=allwords&mssfdt=&mssfdf=&mssfd=Silni%C4%8Dn%C3%AD+doprava&mssff=STK), které ministerstvo dopravy publikuje na webu, lze vyčíst, že při 1,9 milionu *pravidelných* technických kontrol *osobních automobilů* byla od 1. ledna do 31. prosince 2018 drtivá většina (92 procentaa, tedy 1,75 milionu aut) shledáno způsobilými k provozu a jen 1 procento (19 tisíc aut) bylo nezpůsobilých. Přes 133 tisíc osobních aut (7 procent) pak bylo částečně způsobilých.
